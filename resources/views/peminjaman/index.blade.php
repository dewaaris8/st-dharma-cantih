...
@section('content')
    <div class="card">
        ...
        @if ($peminjaman->hasPages())
            <div class="d-flex justify-content-between align-items-center px-3 py-3 bg-light mt-3">
                <div>
                    Menampilkan {{ $peminjaman->firstItem() }} - {{ $peminjaman->lastItem() }} dari {{ $peminjaman->total() }} data peminjaman
                </div>
                <div>
