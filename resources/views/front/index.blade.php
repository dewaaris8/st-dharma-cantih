...
<section>
  <div class="w-full mt-10 flex flex-col md:flex-row h-auto md:h-[500px] items-center justify-between">
    ...
    <div class="flex-1 w-full h-[250px] md:h-full rounded-t-xl md:rounded-l-xl overflow-hidden">
...
<section>
  <div class="w-full flex flex-col md:flex-row-reverse h-auto md:h-[500px] relative items-center justify-between mt-10">
    ...
    <div class="flex-1 w-full relative mt-6 md:mt-0 flex items-center justify-center md:justify-end">
      <!-- Blue background hanya tampil di desktop -->
      <div class="hidden md:block w-[60%] absolute left-0 bg-blue-500 h-[450px] rounded-r-xl"></div>

      <!-- Embla Slider tetap -->
      <div class="overflow-hidden w-full z-10 rounded-r-lg h-auto px-4 md:px-0" id="embla">
        <div class="flex touch-pan-y gap-4">
          <div class="flex-[0_0_85%] sm:flex-[0_0_70%] md:flex-[0_0_60%] lg:flex-[0_0_66%] h-[250px] md:h-[350px] pr-4">
